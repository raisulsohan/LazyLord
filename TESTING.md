...
## প্যানেলে আপডেটের খবর (v1.1.8) — আসল অ্যাপে এখনো চালানো হয়নি

প্যানেল দিনে দুবার GitHub-এ দেখে নতুন রিলিজ এসেছে কিনা। mock টেস্টে পাস করেছে, আর ব্রাউজারে
GitHub-এর আসল উত্তর দিয়েও চালানো হয়েছে। Adobe অ্যাপের ভেতর থেকে GitHub-এ পৌঁছাতে পারে কিনা,
সেটাই দেখার বাকি।

- [ ] ⚠ প্যানেল খুলে হেডারে লোগোর পাশের ভার্সনে (`v1.1.8`) ক্লিক করুন। Log-এ "This is the latest LazyLord (1.1.8)." আসে? তিনটে অ্যাপেই দেখুন। "Could not check for updates…" এলে পুরো লাইনটা পাঠান।
- [ ] ইন্টারনেট বন্ধ করে আবার ক্লিক করুন। "Could not check for updates: no connection." আসে, আর প্যানেলের বাকি সব আগের মতো চলে?
- [ ] "Check for updates"-এর টিক তুলে প্যানেল বন্ধ করে আবার খুলুন। টিক তোলাই থাকে?
- [ ] ⚠ পরের রিলিজ বের হলে 1.1.8 বসানো প্যানেল খুলুন (কয়েক সেকেন্ড অপেক্ষা করুন)। উপরে "LazyLord 1.1.9 is out" কার্ড আর রিলিজের পয়েন্টগুলো আসে? **Download** চাপলে ব্রাউজারে রিলিজ পেজ খোলে? **Later** চাপলে কার্ড সরে যায়, প্যানেল আবার খুললেও ফেরে না, কিন্তু হেডারে "v1.1.8 · update" থাকে আর তাতে ক্লিক করলে কার্ড ফেরে?
