...
## প্যানেলে আপডেটের খবর (v1.1.8–1.1.9) — আসল অ্যাপে এখনো চালানো হয়নি
...
সবচেয়ে সহজ পরীক্ষা: আগে **1.1.8** বসান (GitHub Releases-এ আছে), তারপর 1.1.9।

- [ ] ⚠ 1.1.8 বসানো প্যানেল খুলে কয়েক সেকেন্ড অপেক্ষা করুন। উপরে "LazyLord 1.1.9 is out" কার্ড আসে, তাতে রিলিজের পয়েন্ট থাকে? তিনটে অ্যাপেই দেখুন। কার্ড না এলে হেডারে লোগোর পাশের ভার্সনে ক্লিক করে Log-এর শেষ লাইনটা পাঠান।
- [ ] **Download** চাপলে ব্রাউজারে 1.1.9-এর রিলিজ পেজ খোলে?
- [ ] **Later** চাপলে কার্ড সরে যায়, প্যানেল বন্ধ করে আবার খুললেও ফেরে না, কিন্তু হেডারে "v1.1.8 · update" থাকে আর তাতে ক্লিক করলে কার্ড ফেরে?
- [ ] 1.1.9 বসিয়ে ভার্সনে ক্লিক করুন। Log-এ "This is the latest LazyLord (1.1.9)." আসে?
